...
// VERTER s21_memmove Functional test output: False.
// VERTER s21_memmove Memory test: OK
...
// VERTER s21_strncat Functional test output: False
// VERTER s21_strncat Memory test: FAIL
